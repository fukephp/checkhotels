    ...
    <div class="col-lg-4">
        <div class="card bg-light mt-3" style="width: 100%;">
            <div class="card-body">
                ...
                {{-- <p class="card-text">Get current locations of hotels or current weather in selected place. You can store all information about this place.</p> --}}
            </div>
            <div class="card-footer">
                <a href="{{ route('place.hotel.export', $place->id) }}" class="btn btn-primary btn-sm float-left">Export near hotels</a>
                <a href="{{ route('place.weather.export', $place->id) }}" class="btn btn-primary btn-sm float-right">Export weather</a>
            </div>
        </div>
    </div>
@endforeach
